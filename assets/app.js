(() => {
  ...
  const productData = [
    ...
    { slug:'nado-c2-1000w', imageVersion:'26', name:'Nado C2 1000W', category:'bike', sourceType:'variants', review:'/bicicletas-eletricas/reviews/nado-c2-1000w/', url:'https://meli.la/1QwaXyE', maxSpeed:'até 32 km/h (declarada)', eyebrow:'Variante 1000 W analisada', specs:[['Motor declarado','1000 W'],['Bateria declarada','48 V · 20 Ah · 960 Wh'],['Autonomia anunciada','até 60 km']], ideal:'Trajetos urbanos individuais com bateria removível, cesta e recarga planejada.', watch:'Confirme carga máxima, freios, dimensões, versão e enquadramento legal.' },
    { slug:'yoo-y200-350w', imageVersion:'23', name:'Yoo Y200 350W', category:'bike', sourceType:'variants', review:'/bicicletas-eletricas/reviews/yoo-y200-350w/', url:'https://meli.la/29VesrU', maxSpeed:'até 32 km/h (declarada)', eyebrow:'Variante 350 W analisada', specs:[['Motor declarado','350 W'],['Bateria declarada','48 V · 12 Ah · 576 Wh'],['Autonomia anunciada','até cerca de 20 km']], ideal:'Trajetos urbanos curtos, com cesta frontal, assento duplo e recarga planejada.', watch:'Confirme a variante 350 W/12 Ah, a velocidade e o enquadramento legal.' },
      ...
      result.innerHTML = `
        ...
        <div class='finder-result-layout'>
          <a class='finder-result-photo' href='${found.review}' aria-label='Ler análise completa do ${esc(found.name)}'>
            <img src='${productImage(found)}' alt='${esc(found.name)}' width='1200' height='900' decoding='async'>
          </a>
